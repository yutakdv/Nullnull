...
| A-029 | staging 총비용 상한은 **$200**, 운영 종료일은 **2026-10-25**다 | 2026-09-14 오너가 기존 $150/약 1개월 결정을 교체했다. 서울 region에서 CloudFront VPC origin, ECS api 1(ai 1), RDS Multi-AZ를 기본으로 하고 심사 기간에만 api 2로 확장한다. 계획치는 $170~185이며 Budget actual/forecast 50/75/80/90/97.5/100% 알림과 종료일 teardown gate가 완료 증거다 |
...
지도/경로 provider(A-051), 계정 로그인(A-052), 게시물 작성 moderation(A-053)은 2026-09-20에 결정됐으나 셋 다 P1이므로 P0 blocker가 아니며 기능을 OFF로 유지한다.
