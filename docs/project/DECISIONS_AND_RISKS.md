...
지도/경로 provider(A-051), 계정 로그인(A-052), 게시물 작성 moderation·미디어 입력(A-053·A-057)은 2026-09-20에 결정됐으나 모두 P1이므로 P0 blocker가 아니며 기능을 OFF로 유지한다.
