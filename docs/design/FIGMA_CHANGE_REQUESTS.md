...
FCR 번호는 기존 참조를 보존한다. FCR-010~015는 09-06 PR #6 계약 검토에서, FCR-016~028은 09-06 직접 canvas 대조와 API 검토에서, FCR-029는 FE-103, FCR-030은 FE-301, FCR-031은 FE-303, FCR-032는 FE-306, FCR-033은 FE-307 범위 확정 중 계약·컴포넌트 규칙 대조에서, FCR-034는 FE-505 구현 중 Figma frame 실측에서, FCR-037은 FE-306 진입점 복구 중 추가했다. 등록은 문서 기준선이며 디자인 수정 완료를 뜻하지 않는다.
