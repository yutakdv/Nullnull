...
- P0 정식 계정 로그인·회원가입·소셜 login. P0의 로그인 표현은 A-075(오너 2026-09-25)대로 /sign-in 흉내(공모전 테스트 계정 prefill, 브라우저 안 대조, 요청 0건)와 프로필 `TEST` 표기다.
...
- 작성자 표시·하트 수·좋아요/숨기기 반응도 P0 화면에서 제외한다(범위와 근거는 `docs/design/FIGMA_CHANGE_REQUESTS.md`의 FCR-024).
