...
- 이 기준에서 [ENVIRONMENT.md](../operations/ENVIRONMENT.md)가 적은 공개 flag의 전제(T3 staging 증거)가 충족됐는지는 이 카드가 정하지 않는다. staging은 이미 켜져 있고, 그 판단은 오너 몫으로 남긴다.
