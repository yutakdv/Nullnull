...
const FIXTURE_OF = {
  ...
  optimizationQueued: 'optimizations/run-queued.json',
  optimizationFailed: 'optimizations/run-failed.json',
  decisionApply: 'optimizations/decision-apply.json',
  decisionKeep: 'optimizations/decision-keep.json',
  decisionRevert: 'optimizations/decision-revert.json',
  canonicalPlace: 'places/place-detail.json',
  ...
  itemReplaced: 'trips/mutation-replace.json',
  constraintSet: 'trips/mutation-constraint-set.json',
  constraintRemoved: 'trips/mutation-constraint-remove.json',
  itemRemoved: 'trips/mutation-remove.json',
  importNeedsReview: 'imports/draft-needs-review.json',
  importReady: 'imports/draft-ready.json',
  importConfirmed: 'imports/confirmed-trip.json',
  preferencesUpdated: 'session/owner-profile-onboarded.json',
  eventsAccepted: 'analytics/receipt-accepted.json',
  eventsResent: 'analytics/receipt-resent.json',
