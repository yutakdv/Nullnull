...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"placeName": "경복\n궁"}, "a place name that would render a two-line summary"),
        ({"metricLabel": "상대\t집중률"}, "a metric label carrying a control character"),
        ({"attribution": "출처:\r ⓒ한국관광공사"}, "a source line carrying a control character"),
